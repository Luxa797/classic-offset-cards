import{E as e,aG as c,at as i}from"./index-DM-CIWAp.js";const x=({id:r,label:n,options:d,error:s,className:a="",placeholder:l,...o})=>e.jsxs("div",{className:c("w-full",a),children:[n&&e.jsxs("label",{htmlFor:r,className:"block text-sm font-medium text-foreground mb-1.5",children:[n," ",o.required&&e.jsx("span",{className:"text-destructive",children:"*"})]}),e.jsxs("div",{className:"relative",children:[e.jsxs("select",{id:r,className:c(`
