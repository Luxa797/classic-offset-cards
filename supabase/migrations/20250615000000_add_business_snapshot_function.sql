-- supabase/migrations/YYYYMMDDHHMMSS_add_business_snapshot_function.sql
...
DECLARE
    ...
    -- Use the start of the current month if start_date is not provided
...
BEGIN
    ...
    RETURN jsonb_build_object(
        ...
        'payments', jsonb_build_object(
            'due_summary', due_payments_summary
        )
    );
END;
$$;
